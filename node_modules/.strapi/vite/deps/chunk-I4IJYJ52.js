...
import {
  ...
  HOOKS
} from "./chunk-2NDVET73.js";
import {
  useNpsSurveySettings
} from "./chunk-ZZBRADOS.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-R7LPFFWX.js";
import {
  useGetAIUsageQuery
} from "./chunk-XV2GPTQY.js";
import {
  require_pick
} from "./chunk-CXQPECQP.js";
import {
  useEnterprise
} from "./chunk-4UDXKGFX.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-TZ366KDL.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-OI42C7GN.js";
import {
  Login
} from "./chunk-QOCPVTPF.js";
import {
  MemoizedInputRenderer
} from "./chunk-DFM2SDPU.js";
import {
  Form
} from "./chunk-N2PQIZDZ.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-NXICJ33Q.js";
import {
  ConfigurationProvider
} from "./chunk-MIRY4T4O.js";
import {
  require_merge,
  require_omit
...
import {
  Layouts
} from "./chunk-Q53QLPI2.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-VL7BKV5N.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-OBBWPVGK.js";
import {
  getByteSize
} from "./chunk-PQINNV4N.js";
import {
  RESPONSIVE_DEFAULT_SPACING
} from "./chunk-KOCWIB5I.js";
import {
  require_isEqual
...
import {
  Page,
  useAPIErrorHandler
} from "./chunk-JJDUUH3O.js";
import {
  ForwardRef$k
} from "./chunk-VMAP6D4U.js";
import {
  AuthProvider,
  StrapiAppProvider,
  getOrCreateDeviceId,
...
} from "./chunk-PZMB7AC3.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-66EMMQDP.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-UPXR3TIH.js";
import {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-PLGLTF35.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-3E6LQP77.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-ZXNGN2VL.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-LO66S7PZ.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-WHA4MHQ6.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-4ET3UYVB.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-7HT6FXRC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-QKY53QR4.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-REH4NHC3.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-K3CSA5EQ.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-RMKTOMIF.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-GSLKT74Q.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-3KHWZNQY.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-WER6CGIQ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-4UWYG7XO.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-SYRKAYDT.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-NCXH5ZQD.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-5PG7VM52.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-IRBE7VJO.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-DU6Z4ELF.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-YROOWWQP.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-YFG7NYVG.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-OEAP5JPO.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-WETKVOYG.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-5FA4YY7B.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-YLOWLASA.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-3JZJ2MQU.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-WJTTQGWL.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-5BVUYQGU.js");
              return {
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    ...
    case "./translations/ru.json":
      return import("./ru.json-WE7H7DGF.js");
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-YLDZVCC3.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-YLDZVCC3.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-5CO5OOFC.js");
...
//# sourceMappingURL=chunk-I4IJYJ52.js.map
