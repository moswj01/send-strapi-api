import {
  ...
  QueryClientProvider,
  img
} from "./chunk-GRAVXCKX.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-FLFZYF35.js";
import {
  useNpsSurveySettings
} from "./chunk-NWIKWTQT.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-PXO52M27.js";
import {
  useGetAIUsageQuery
} from "./chunk-3F4U6BGK.js";
import {
  require_pick
} from "./chunk-OCCCKJPD.js";
import {
  getBasename
...
import {
  ...
  getEERoutes
} from "./chunk-KGN35MOX.js";
import {
  Login
} from "./chunk-NLQUEMBE.js";
import {
  MemoizedInputRenderer
} from "./chunk-NQ6N7JW3.js";
import {
  Form
} from "./chunk-WBEEMCLH.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-4YNO7F2C.js";
import {
  ConfigurationProvider
} from "./chunk-A6WXXODO.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-KYNDK6TO.js";
import {
  require_baseRest
} from "./chunk-ZUHLGKEZ.js";
import {
  HistoryProvider
} from "./chunk-VBF6GNNG.js";
import {
  errorsTrads
...
import {
  TrackingProvider,
  useTracking
} from "./chunk-IKKBTXZV.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-BVSHCQCY.js";
import {
  getByteSize
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-3BODWF65.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-UHPOKCFP.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-43E6PQIL.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-WLMEKYH3.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-I7OKTARJ.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-PYNPWGSC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-QUNV5MXW.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-R3JD4PMG.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-R2MMIN76.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-OVHIEJ7G.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-PYMAMOUW.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-CNNHRAGJ.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-NIKIJ6WS.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-UMPQP2J4.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-K5S4RIS2.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-HSLUH23R.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-77QOFRNH.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-YHFUXGGR.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-653DYAIM.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-W62CA3RP.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-JYVJTSKP.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-236XWSZT.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-2J4CX6YN.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-WFUPCSQK.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-3GFKWZMQ.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-WCNGJL2I.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-6RTZQK5Q.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-6RTZQK5Q.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-RIXTR3AS.js");
...
//# sourceMappingURL=chunk-KF2DPR5I.js.map
