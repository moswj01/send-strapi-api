import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-DDT2WDGC.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-7F3LVKSN.js";
import {
  LimitsModal
} from "./chunk-HHA52ACZ.js";
import {
...
} from "./chunk-RVEYP54Q.js";
import {
  useTypedSelector
} from "./chunk-SQL22URO.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-6W62JRLF.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-AFNLKQWB.js";
import {
  index
} from "./chunk-H3JPQ5V3.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-ZZNBBZWL.js";
import {
  useConfig,
  useTracking
} from "./chunk-JMCIFNJQ.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-CSX63TBN.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-C3UV6MGM.js";
import {
  renderAdmin
} from "./chunk-KF2DPR5I.js";
import {
  useAIAvailability
} from "./chunk-PXO52M27.js";
import {
  useLicenseLimits
} from "./chunk-466JEKKS.js";
import {
  Table,
  useTable
} from "./chunk-74BJZM3N.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-62X3F2L6.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-SCQQKT3O.js").then((mod) => ({
    ...
    children: [
      ...
      (0, import_jsx_runtime9.jsxs)(TabsRoot, {
        ...
        children: [
          ...
          (0, import_jsx_runtime9.jsx)(ScrollAreaImpl$1, {
            children: (0, import_jsx_runtime9.jsxs)(Modal.Body, {
              children: [
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-IHLBFX5H.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-7WCXKMZA.js");
        return {
...
var TextAlignTypography2 = at(Typography)`
  text-align: center;
`;
...
var AITranslationStatusIcon = at(Status)`
  display: flex;
...
`;
var SpinningLoader = at(ForwardRef$1b)`
  @keyframes spin {
    from {
...
var StyledTrash = at(ForwardRef$b)`
  path {
    fill: currentColor;
  }
`;
  ...
  return (0, import_jsx_runtime21.jsxs)(Span, {
    ...
    children: [
      ...
      (0, import_jsx_runtime21.jsx)(TooltipImpl, {
        ...
        children: (0, import_jsx_runtime21.jsx)(ForwardRef$1Z, {
          "aria-hidden": true,
          focusable: false
        })
      })
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-MW6FGI4Q.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-JRVLGRCG.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-U7VQ3JBF.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-6G2CM2MA.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-LZC7XXOF.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-5H4JELY4.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-CT3HFPRP.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-VOAVGT5T.js");
          return {
...
//# sourceMappingURL=chunk-SN4MG4BF.js.map
