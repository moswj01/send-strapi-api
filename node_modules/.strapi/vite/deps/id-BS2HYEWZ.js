...
var AccordionRoot = at(Accordion.Root)`
  border: 1px solid
    ${({ theme, $error }) => $error ? theme.colors.danger600 : theme.colors.neutral200};
`;
var ContextMenuTrigger = at(Menu.Trigger)`
  :hover,
  :focus {
...
var NestedOption = at(MultiSelectOption)`
  padding-left: ${({ theme }) => theme.spaces[7]};
`;
var PermissionWrapper = at(Flex)`
  > * {
    flex-grow: 1;
  }
`;
...
var NestedOption2 = at(MultiSelectOption)`
  padding-left: ${({ theme }) => theme.spaces[7]};
`;
var ContentTypeTakeNotice = at(Typography)`
  font-style: italic;
`;
...
//# sourceMappingURL=id-BS2HYEWZ.js.map
