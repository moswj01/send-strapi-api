import {
  ...
  useSelectionState,
  useUpload
} from "./chunk-YO4XV6NE.js";
import {
  useConfig,
  useTracking as useTracking2
} from "./chunk-IRY5X63W.js";
import {
  AssetType,
  DocType,
  getTrad,
...
var CardActionsContainer = at(CardActionImpl)`
  opacity: 0;
  z-index: 1;
...
`;
var VideoTimerOverlay = at(CardTimer)`
  position: absolute;
  bottom: 0.5rem;
  right: 0.5rem;
`;
...
var StyledCardBody = at(CardBody)`
  display: flex;
  padding: ${({ theme }) => theme.spaces[2]} ${({ theme }) => theme.spaces[1]};
`;
var StyledCard = at(Card)`
  width: 100%;
  height: 100%;
  border: none;
  box-shadow: none;
...
// node_modules/@strapi/upload/dist/admin/pages/App/App.mjs
var ConfigureTheView = React6.lazy(async () => import("./ConfigureTheView-IQKJGVPT.js").then((mod) => ({
...
//# sourceMappingURL=App-XVIXIYU5.js.map
